...
import { type UpdateFigureInput } from '@server/src/modules/figures/dto/updateFigureInput';
...
export class FiguresService {
    ...
    async createOrUpdate(
        createFigureInput: CreateFigureInput
    ): Promise<Figure> {
        const figure = await this.figuresRepository.findOne({
    ...
    async findAll(
        findManyOptions?: FindManyOptions<Figure>
    ): Promise<Figure[]> {
